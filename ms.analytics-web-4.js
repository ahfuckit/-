...
(function (global, factory) {
    ...
    (function(global){
        var nsKey, key, nm, theExports = {}, modName = "es5_ms_analytics_web_4_3_12", msMod="__ms$mod__";
        var mods={}, modDetail=mods[modName]={}, ver="4.3.12";
...
function redactQueryParameters(url, config) {
    ...
    if (queryString && queryString[_DYN_LENGTH$4 ]) {
        var pairs = queryString[_DYN_SPLIT$2 ]("&");
...
function createCookieMgr(rootConfig, logger) {
    ...
    function _formatDeletionValue(path) {
        ...
        return _formatCookieValue(STR_EMPTY$3, values);
    }
...
//# sourceMappingURL=ms.analytics-web-4.3.12.js.map
